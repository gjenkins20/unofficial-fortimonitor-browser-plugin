...
import {
  ...
  runAllAnalyzers
} from '../src/lib/observation-analyzers/index.js';
import { trendLabel, extractCheckType } from '../src/lib/observation-analyzers/incident.js';
import {
  counter,
  mostCommon,
  parseTimestamp,
...
} from '../src/lib/observation-analyzers/_helpers.js';
...
// data from `template_monitoring_configs` (ObservationsFrontendFetcher) rather
