...
export function render({ container, store, navigate }) {
  ...
  dlCsv.addEventListener('click', (e) => {
    e.preventDefault();
    const header = csvAttributionHeader('add');
    const rows = [['server_id', 'device_name', 'group_fingerprint', 'add_ports', 'kept_port_names']];
...
// Add-ports-× count, so we don't duplicate that here.
