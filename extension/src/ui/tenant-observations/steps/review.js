...
// Tenant Observations - Step 4 (Review) - FMN-133.
//
...
export function render({ container, store, navigate }) {
  ...
  frame.appendChild(h('div', { class: 'step-header' },
    ...
    h('h2', {}, store.customerName
      ? `${store.customerName} - Tenant Observations`
      : 'Tenant Observations'),
    h('p', { class: 'muted' },
  ...
  const viewerHost = h('div', { class: 'body-section observations-viewer-host' });
  ...
  // tenant observations - no per-tool flag to resolve before rendering.
