...
// FMN-196: Bulk action - Apply Best-Practice Fabric Templates.
//
...
export const id = 'apply-best-practice-fabric';
export const label = 'Apply Best-Practice Fabric Templates';
